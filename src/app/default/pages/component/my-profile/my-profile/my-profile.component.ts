...
export class MyProfileComponent implements OnInit {
  ...
  changeEmails(): void {
    ...
    this.updateSpinner("spinner", true);
    this.MyProfileService.changeEmail(params).subscribe((res: any) => {
      if (res && res?.status == 1) {
        this.emailSubmitted = false;
        this.emailForm.reset();
        this.updateSpinner("spinner", false);
  ...
  // spinner
  private updateSpinner(property: string, value: boolean = false): void {
