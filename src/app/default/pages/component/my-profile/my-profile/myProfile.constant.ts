...
export const myProfileFormObj = {
    firstName: {
        ...
        validatiors: [Validators.required,Validators.maxLength(30),CustomValidatorsName.patternValidator(ALLOWED_PATTERN, { onlyAlphabets: true})],
        type: 'text',
    ...
    lastName: {
        ...
        validatiors: [Validators.maxLength(30),CustomValidatorsName.patternValidator(ALLOWED_PATTERN, { onlyAlphabets: true })],
        optionalErrorMessage:{
            onlyAlphabets: 'ValidationsErrorMessage.Allowonlyalphabetsspaces',
             }, 
        type: 'text',
