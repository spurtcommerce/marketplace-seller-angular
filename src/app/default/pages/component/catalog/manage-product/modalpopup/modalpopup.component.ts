...
export class ModalPopupComponent implements OnInit {
  ...
  constructor(public activeModal: NgbActiveModal, public productSandbox: ProductSandbox, public settingSandbox: SettingsSandbox,) {
  ...
  deleteContent() {
    if (this.key === 'vendor') {
      ...
      this.settingSandbox.deleteCoupon(params);
      this.subscriptions.add(this.settingSandbox.deleteCouponLoaded$.subscribe(_delete => {
        if (_delete === true) {
