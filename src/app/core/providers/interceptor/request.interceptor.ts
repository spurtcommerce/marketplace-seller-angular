        ...
        return next.handle(req).pipe(
            map((responsedata: any) => {
                if (responsedata instanceof HttpResponse) {
                    ...
                    if (response && response.message !== '' && req.method !== 'GET' && req.method !== 'POST' && !req.url.includes('vendor-product-specification/attribute-slug/product') && !req.url.includes('vendor-product-specification/product'.toLowerCase()) && !req.url.includes('vendor/pending-status/update/'.toLowerCase()) && !req.url.includes('vendor/forgot-password-link'.toLowerCase()) && response.message !== 'Successfully update pending status..!' && response.message !== 'Successfully Updated Order..!') {
