...
import { createCoupon, productList, categoryList, couponList,
         ...
         couponListCount, deleteCoupon,deleteCouponLoaded,deleteCouponFailed, couponDetails, updateCoupon, couponDetailsLoading,
...
export class SettingsSandbox {
  ...
  public deleteCouponLoaded$ = this.appState$.select(deleteCouponLoaded);
  public deleteCouponFailed$ = this.appState$.select(deleteCouponFailed)
