...
export class PaymentSandbox {
  ...
  //Payment Revoke
  public PaymentRevoke$ = this.appState.select(PaymentRevoke);
  public PaymentRevokeLoading$ = this.appState.select(PaymentRevokeLoading);
  public PaymentRevokeLoaded$ = this.appState.select(PaymentRevokeLoaded);
  ...
  //Payment Revoke
  public PaymentRevoke(value) {
    this.appState.dispatch(new paymentActions.PaymentRevokeAction(value));
  }
}
