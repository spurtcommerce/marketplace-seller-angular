...
*/
  ...
  // Payment Revoke 
    ...
    public PaymentRevoke(params): Observable<any> {
      let obj={
        "vendorPaymentArchiveId":params
      }
      return this.http.post(this.basUrl + '/vendor-sales/revoke-vendor-payment-archive',obj);
    }
}
