...
export const PaymentRevoke = createSelector(
  getProdState,
  fromPayment.PaymentRevoke
);
export const PaymentRevokeLoading = createSelector(
  getProdState,
  fromPayment.PaymentRevokeLoading
);
export const PaymentRevokeLoaded = createSelector(
  getProdState,
  fromPayment.PaymentRevokeLoaded
);
