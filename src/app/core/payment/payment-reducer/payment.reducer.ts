...
// <---------------ARCHIVE PAYMENT LIST COUNT----------------> //
    ...
    case actions.ActionTypes.EXPORT_ARCHIVE_REVOKE: {
      return Object.assign({}, state, {
        PaymentRevokeLoading: true,
        PaymentRevokeLoaded: false,
        PaymentRevokeFailed: false,
        PaymentRevoke: '',
      });
    }

    case actions.ActionTypes.EXPORT_ARCHIVE_REVOKE_SUCCESS: {
      return Object.assign({}, state, {
        PaymentRevokeLoading: false,
        PaymentRevokeLoaded: true,
        PaymentRevokeFailed: false,
        PaymentRevoke: payload,
      });
    }

    case actions.ActionTypes.EXPORT_ARCHIVE_REVOKE_FAIL: {
      return Object.assign({}, state, {
        PaymentRevokeLoading: false,
        PaymentRevokeLoaded: false,
        PaymentRevokeFailed: true,
        PaymentRevoke: '',
      });
    }
...
export const downloadInvoiceFailed = (state: PaymentState) =>
  ...
  //Payment revoke
  export const PaymentRevoke = (state: PaymentState) => state.PaymentRevoke;
  export const PaymentRevokeLoading = (state: PaymentState) => state.PaymentRevokeLoading;
  export const PaymentRevokeLoaded = (state: PaymentState) => state.PaymentRevokeLoaded;
