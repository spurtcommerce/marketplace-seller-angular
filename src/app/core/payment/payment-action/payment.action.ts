...
export const ActionTypes = {
  ...
  EXPORT_ARCHIVE_REVOKE: type('[main csv] Revoke Payment'),
  EXPORT_ARCHIVE_REVOKE_SUCCESS: type('[main csv] Revoke Payment Success'),
  EXPORT_ARCHIVE_REVOKE_FAIL: type('[main csv] Revoke Payment Fail'),
};
...
// Revoke
export class PaymentRevokeAction implements Action {
  type = ActionTypes.EXPORT_ARCHIVE_REVOKE;
  constructor(public payload: any = null) { }
}

export class PaymentRevokeSuccess implements Action {
  type = ActionTypes.EXPORT_ARCHIVE_REVOKE_SUCCESS;
  constructor(public payload: any) { }
}

export class PaymentRevokeFail implements Action {
  type = ActionTypes.EXPORT_ARCHIVE_REVOKE_FAIL;
  constructor(public payload: any = null) { }
}
