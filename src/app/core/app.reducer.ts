...
import * as fromSupplierManagement from "./suppliers-management/reducer/suppliersManagement.reducer";
import * as fromContact from "./suppliers-contact/reducer/suppliersContact.reducer";
import * as fromCrmGroups from "./crmGroups/crmGroups-reducer/crmGroups.reducer"
import * as fromExport from './product-configuration/export/export.reducer/export.reducer';
import * as fromImport from './product-configuration/import/reducer/import.reducer';
...
export const CoreReducers = {
  ...
  supplierManagement:fromSupplierManagement.reducer,
  supplierContact:fromContact.reducer,
